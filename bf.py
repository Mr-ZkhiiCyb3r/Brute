...
def banner():
    ...
    runntxt(GG+"      Kembali lagi dengan saya Mr-ZkhiiCyb3r")
    runntxt(WW+"  Hari ini saya akan memberikan Tools BRUTEFORCE")
    runntxt(Y+"   Sebelum menjalankan Tools ini harap berdoa dulu")
    runntxt(B+"           Supaya bisa dapet korban:v")
    runntxt(wd+"1. bismi allaahi alrrahmaani alrrahiimi.")

    runntxt(WW+"2. alhamdu lillaahi rabbi al’aalamiina.")

    runntxt(Y+"3. alrrahmaani alrrahiimi.")

    runntxt(RR+"4. maaliki yawmi alddiini.")

    runntxt(GG+"5. iyyaaka na’budu wa-iyyaaka nasta’iinu.")

    runntxt(GL+"6. ihdinaa alshshiraatha almustaqiima.")

    runntxt(R+"7. shiraatha alladziina an’amta ‘alayhim ghayri almaghdhuubi ‘alayhim walaa aldhdhaalliina.")

    runntxt(GG+" Sodaqallahhuladzim")

    runntxt(WW+'   __________                __                               ')         
    runntxt(GL+'   \______   \_______ __ ___/  |_ _____                  ')
    ...
    time.sleep(1.5)
    print GG+"[ ]============================================[ ]"
    print GL+" [>>>>>>>>>>>>>>>,, Mr-ZkhiiCyb3r ,,<<<<<<<<<<<<]"
    print GG+" [===============_____BRUTEFORCE________________]"
    print WW+" [                                              ]"
    print GL+" [¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤]"
    print WW+" [            MOOD BY : Mr-ZkhiiCyb3r           ]"
    print  Y+" [   GITHUB : https://github.com/Mr-ZkhiiCyb3r  ]"
    print GL+" [              TOOLS  : BRUTEFORCE             ]"
    print GL+" [                                              ]"
    print GL+" [¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤]"
    print GG+" [**************> SHARK CYBER TEAM <************]"
    print GL+" [¤¤¤¤¤¤¤¤¤¤¤¤¤¤________S.C.T_______¤¤¤¤¤¤¤¤¤¤¤¤]"
    print GG+"[ ]____________________________________________[ ]"

banner()

runntxt( wd+"         https://github.com/Mr-ZkhiiCyb3r ")
...
def pil():
                ...
                if g == 'y' or g == 'Y':
                    ...
                    print RR+"Pilih yang bener Om..."
                    pil()

def edit_wordlist():

        print GG+" "
        ed = str(raw_input("[?] Edit wordlist Om.? \033[96;1m[y/n]: "))
        if ed == 'y' or ed == 'Y':
         ...
         `:o:``....--        ..     `:o:`
           `:+/-`  `-        ..  `-/+:`
              `-/+///..````..://+/-`
                ...
                \033[90;1mShark Cyber Team\033[91;1m
              Powered by:\033[97m Mr-ZkhiiCyb3r
      """
